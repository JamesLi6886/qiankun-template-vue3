<template>
  <el-form :inline="true" :model="state.searchObj">
    ...
    <el-form-item>
      <el-button type="primary" class="c-search-button" icon="el-icon-search" @click="fetchData(true)">
        查询
      </el-button>
    </el-form-item>
  </el-form>
  <div class="flex justify-content-between align-items-center mb-5">
    ...
    <div class="flex">
      <el-tooltip effect="dark" content="下载当前页数据" placement="top">
      ...
      <!--      </el-tooltip>-->
      <el-tooltip effect="dark" content="展示列配置" placement="top">
        <div>

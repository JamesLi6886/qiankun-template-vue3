...
import BreadcrumbCommon from "@/../common/components/breadcrumbCommon.vue"
import '@/../common/css/global.scss'
import { generateGitMessage } from '@/../common/utils/gitMessage/index.js'
generateGitMessage(process.env, ProjectVersion);
let router = null;
let instance = null;
let history = null;
function render(props = {}) {
    ...
    instance.component('TableDeleteLink', TableDeleteLink) // 公共表格内操作删除按钮组件
    instance.component('BreadcrumbCommon', BreadcrumbCommon) // 公共面包屑组件
